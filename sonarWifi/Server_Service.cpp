...
<body>
  ...
  <div class="content">
    <div class="cards">
      <div class="card">
        <p><i class="fas fa-thermometer-half" style="color:#059e8a;"></i> TEMPERATURE</p><p><span class="reading"><span id="temp">
</span> &deg;C</span></p>
      </div>
    </div>
  </div>
...
if (!!window.EventSource) {
 ...
 source.addEventListener('d', function(e) {
...
void ServerService::sendEvent(char c, int distance)
{
  ...
  events.send(String(distance).c_str(),c,millis());
}
